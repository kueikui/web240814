...
.data-table td {
    ...
    <main aria-labelledby="title">
          <h1>長者資料</h1>
    <asp:Panel ID="Panel1" runat="server">新增一筆資料<asp:Button ID="Add" runat="server" CssClass="button" OnClick="Add_Click" Text="新增" />
        &nbsp;&nbsp;&nbsp;
        ...
        <asp:GridView ID="GridView1" CssClass="gridview" runat="server" OnRowCommand="GridView1_RowCommand" EnableSortingAndPagingCallbacks="True" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" PageSize="5">
    ...
    <asp:Panel ID="Panel4" runat="server" BackColor="#FFCCCC" Visible="False">
